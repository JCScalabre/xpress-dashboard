			...
			<div>
				...
				>
					...
					<Form>
						...
						<Divider />
						<p>
							To sign into your personal dashboard, enter your email
							address. An email will be sent out immediately containing a sign
							in link.
						</p>
						<Form.Input
							icon="mail"
						...
						<Button
							...
							style={{ backgroundColor: "#3b3872", color: "#ffffff" }}
						>
							Send Link
						</Button>
						{this.props.message !== "" ? (
